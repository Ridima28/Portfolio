...
const HeroSection = ({darkMode}) => {
    ...
    const darkTheme = {
        ...
        buttonSecondary: 'text-white border-2 border-purple-500 hover:bg-gradient-to-r from-purple-500 to-blue-500',
        decorativeCircle: 'bg-purple-500 opacity-10'
    };
    const lightTheme = {
        textPrimary: 'text-gray-900',
        textSecondary: 'text-gray-700',
        buttonSecondary: 'text-white border-2 border-purple-100 hover:bg-gradient-to-r from-purple-500 to-blue-500 hover:text-white',
        decorativeCircle: 'bg-purple-500 opacity-10'
    };
        ...
        <div className='relative overflow-hidden min-h-screen flex flex-col'>
            ...
            className = 'body-font z-10'>
                <div className='container mx-auto flex px-4 sm:px-8 lg:px-20 py-12 lg:py-32 flex-col lg:flex-row items-center justify-between lg:mt-0 mt-14'>
                    ...
                    <h1 className = {`title-font text-4xl sm:text-3xl lg:text-5xl mb-4 font-bold ${theme.textPrimary}`}
                    data-aos = 'fade-up'
                    data-aos-delay = '500'>
                        Hi, I'm Ridima.
                    </h1>
                    <p className={`mb-6 lg:text-2md sm:mb-8 leading-relaxed max-w-md sm:max-w-lg ${theme.textSecondary}`}
                    data-aos = "fade-up"
                    data-aos-delay= '600'>
                    ...
                    <div className = 'w-full pt-4 sm:pt-6'>
                        ...
                        >
                            ...
                            <a href  = '#contact' className='inline-block'>
                                <button className={`w-full sm:w-auto inline-flex items-center ${theme.buttonSecondary} justify-center text-white py-3 px-6 sm:px-8 hover:shadow-[0_0_25px_rgba(168,85,247,0.6),0_0_45px_rgba(59,130,246,0.4)] rounded-full text-base sm:text-lg font-semibold transition-all duration-300 transform`}>
                    ...
                    <div className='lg:w-1/2 w-full max-w-md  lg:scale-120 lg:max-w-lg mt-8 lg:mt-0 flex justify-center'
                    data-aos='fade-left'
                    data-aos-delay = '400'> 
                    ...
                    <img src = {hi}
                    alt = 'hi'
                    className='absolute top-4 sm:top-4 left-6 lg:left-30 sm:left-10 scale-160 w-14 h-14 sm:w-20 sm:h-20 object-contain animate-bounce opacity-90 z-10'/>
                    </div>
                        
                    </div>
                </div>
                <div className = {`absolute top-0 left-15-w-40 h-40 sm:w-64 sm:h-64 ${theme.decorativeCircle} rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse delay-1000 hidden sm:block`} >
